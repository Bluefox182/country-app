...
const Details = (props) => {
  ...
  const renderBorders = (object) => {
    ...
    var filtered = countriesArray.filter(([key, country]) =>
  ...
  const renderSymbol = (object) => {
    const currencies = mapProp(object);
    const monedaArray = currencies.map((currency) => currency.symbol);
    var output = '';
    for (let i = 0; i < monedaArray.length; i++) {
      output += monedaArray[i];
      if (i < monedaArray.length - 1) {
        output += ', ';
      }
    }
    return output;
          ...
          <div className='container-double'>
            ...
            <div className='description'>
              ...
              <div className='info'>
                ...
                <p>
                  <b>Symbol: </b>
                  {renderSymbol(country.currencies)}
                </p>
                <p>
                  <b>Languages: </b>
